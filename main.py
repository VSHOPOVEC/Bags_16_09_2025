...
Amount  = 3
limit_of_thikness = 100; limit_of_time = 100; normalize_const = 10

if __name__ == '__main__':
    d_33 = Data_loader.DataSet("C:/Users/mikhailm/Desktop/F33") 
    ...
    # p_d_160.processing_the_result(100, 0, Amount, 10)
    # p_d_150.processing_the_result(0, 0,Amount,10)
    ...
    # p_d_27.processing_the_result(limit_of_thikness,limit_of_time,Amount,normalize_const)
    # p_d_30.processing_the_result(limit_of_thikness, limit_of_time, Amount, normalize_const)
    # p_d_32.processing_the_result(limit_of_thikness, limit_of_time, Amount, normalize_const)
    # p_d_35.processing_the_result(limit_of_thikness, limit_of_time, Amount, normalize_const)
    # p_d_37.processing_the_result(limit_of_thikness,limit_of_time,Amount,normalize_const)
    # p_d_40.processing_the_result(limit_of_thikness, limit_of_time, Amount, normalize_const)
    # p_d_42.processing_the_result(limit_of_thikness,limit_of_time,Amount,normalize_const)
    # p_d_45.processing_the_result(limit_of_thikness,limit_of_time,Amount,normalize_const)
    # p_d_50.processing_the_result(limit_of_thikness,limit_of_time,Amount,normalize_const)
